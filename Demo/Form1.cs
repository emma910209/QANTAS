    ...
    public partial class Form1 : Form
    {
        ...
        public void bEpcRead_Click(object sender, EventArgs e)
        {
            ...
            if (Uresult == 0)
            {
                ...
                if (result1 == 0)
                {
                    ...
                    int result2 = Api.EpcRead((byte)3, (byte)20, (byte)9, ref IntUsercNo);
                    if (result2 == 0)
                    {
        ...
        private void Information_transfer2(string epcM2)
        {
               ...
               //int PasLength = Int32.Parse(PassagerN.Substring(0, 2));
                ...
                if(FDT != null)
            {
                if (FDT.Length > 26 && FDT.Substring(26,1) != "@")
                {
                    Flight_Data_T.Text = FDT ;
                    Flight_1_tBox.Text = FDT.Substring(0, 6);
                    Console.WriteLine("F1TIME------>" + FDT.Substring(6, 3));
                    F1Date_tBox.Text = new DateTime(DateTime.Now.Year, 1, 1).AddDays(Convert.ToDouble(FDT.Substring(6,3).ToString()) - 1).ToShortDateString();
                    F1Destination_tBox.Text = FDT.Substring(9, 3);
                    F1CabinC_tBox.Text = FDT.Substring(12,1);
                    Flight_2_tBox.Text = FDT.Substring(13, 6);
                    F2Date_tBox.Text = new DateTime(DateTime.Now.Year, 1, 1).AddDays(Convert.ToDouble(FDT.Substring(19, 3).ToString()) - 1).ToShortDateString();
                   ...
                   // F3Date_tBox.Text = new DateTime(DateTime.Now.Year, 1, 1).AddDays(Convert.ToDouble(FDT.Substring(32,3).ToString()) - 1).ToShortDateString();
                   // F3Destination_tBox.Text = FDT.Substring(35, 3);
                   // F3CabinC_tBox.Text = FDT.Substring(38, 1);
                }
                else if  (FDT.Length >13 && FDT.Substring(13, 1) != "@")
                {
          ...
          /*
           ...
           // int nameLength = PASN.Length/2;
            ...
            else
            {
               ...
               Flight_Data_T.Text = FDT;
               FDT = Encode(FDT);
            string FDTLength = Convert.ToString(FDT.Length / 2, 16);
